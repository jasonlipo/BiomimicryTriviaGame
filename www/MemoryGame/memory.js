...
var info = [
		...
		},
		{
			...
			id: "7",
			text: "הטרמיטים גרים במדבריות שבהן הטמפרטורה נעה בין אפס מעלות בלילה ועד לטמפרטורה גבוהה של יותר מ- 40ºC. למרות זאת, בתוך הקן הטמפרטורה קבועה ועומדת על 30.5ºC הטמפרטורה המבוקרת היא פועל יוצא של אופן בניית הקן.  האדריכל מיכאל פירס תכנן מבנה משרדי ומרכז מסחרי שלם בעיר הררה שבזימבבואה המבוסס על תובנות ויסות הטמפרטורה של קן הטרמיטים.",
